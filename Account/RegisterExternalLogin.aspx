<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="RegisterExternalLogin.aspx.vb" Inherits="CBA_PLACAS_BS.RegisterExternalLogin" Async="true" %>

<%@ Import Namespace="CBA_PLACAS_BS" %>
