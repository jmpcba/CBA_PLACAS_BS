...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
	...
	<div class="panel panel-default panel-primary">
		...
		<div id="detalle" class="panel-collapse collapse in">
			<div class="panel-body">
				<div class="row">
                <div class="col-md-3">
                    <strong>Codigo: </strong><asp:Label ID="lblLinea" runat="server" Text="Label"></asp:Label>
                </div>
                <div class="col-md-3">
                    <strong>Nombre: </strong><asp:Label ID="lblChapa" runat="server" Text="Label"></asp:Label>
                </div>
                <div class="col-md-3">
                    <strong>Unidad: </strong><asp:Label ID="lblMadera" runat="server" Text="Label"></asp:Label>
                </div>
            </div>
			</div>
		</div>
	...
	<div class="panel panel-default panel-primary">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a data-toggle="collapse" data-parent="#accordion" href="#produccion">Productos en que se utiliza</a>
			</h4>
		</div>
