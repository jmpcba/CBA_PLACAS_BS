<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="stockProductos.aspx.vb" Inherits="CBA_PLACAS_BS.stockProductos" theme="default"%>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="page-header">
        <h1 class="text-center">Stock de productos<br /><small>
    ...
    <div id="contenedor" class="row table-responsive  form-group">
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" BackColor="#99CCFF" CssClass="reportViewer" ProcessingMode="Remote" Height="100%" ShowFindControls="False" ShowPageNavigationControls="False" ShowZoomControl="False" Width="100%">
            <ServerReport ReportPath="/reportesCBA_Placas/REGISTRO_STOCK_PRODUCTO" ReportServerUrl="http://localhost/reportserver_SSRS" />
        </rsweb:ReportViewer>
    </div>
</asp:Content>
