...
Public Class etiquetasInternas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CBA_PLACAS_BS.etiquetasInternas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedetiquetasInternas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As etiquetasInternas = New etiquetasInternas()
        rpt.Site = Me.Site
        Return rpt
    End Function
