...
Public Class remito_filtrado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CBA_PLACAS_BS.remito_filtrado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedremito_filtrado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As remito_filtrado = New remito_filtrado()
        rpt.Site = Me.Site
        Return rpt
    End Function
